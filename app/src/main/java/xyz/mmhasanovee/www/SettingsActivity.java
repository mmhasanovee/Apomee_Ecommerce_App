...
public class SettingsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        closeTextBtn.setOnClickListener(new View.OnClickListener() { //from navigation drawer
            @Override
    ...
    private void updateOnlyUserInfo()
    {
        ...
        ref.child(Prevalent.CurrentonlineUser.getPhone()).updateChildren(userMap); //getting informations about current online user
    ...
    private void userInfoDisplay(final CircleImageView profileImageView, final EditText fullNameEditText, final EditText userPhoneEditText, final EditText addressEditText)
    {
        ...
        UsersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                {
                    if (dataSnapshot.child("image").exists()) //only shows the information if image has been already uploaded.
                    {
